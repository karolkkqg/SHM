...
public class VacunaDAOTest {
    ...
    public void testObtenerVacunasDelPaciente() throws Exception {
        System.out.println("obtenerVacunasDelPaciente");
        int idPaciente = 0;
        VacunaDAO instance = new VacunaDAO();
        ArrayList<Vacuna> expResult = null;
        ArrayList<Vacuna> result = instance.obtenerVacunasDelPaciente(idPaciente);
    ...
    public void testAgregarVacunaAlAntecedente() throws Exception {
        System.out.println("agregarVacunaAlAntecedente");
        int idPaciente = 0;
        int idVacuna = 0;
        java.sql.Date fechaAplicacion = null;
        VacunaDAO instance = new VacunaDAO();
        int expResult = 0;
        int result = instance.agregarVacunaAlAntecedente(idPaciente, idVacuna, fechaAplicacion);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    public void testEliminarVacunaDeAntecedente() throws Exception {
        System.out.println("eliminarVacunaDeAntecedente");
        int idPaciente = 0;
        int idVacuna = 0;
        VacunaDAO instance = new VacunaDAO();
        int expResult = 0;
        int result = instance.eliminarVacunaDeAntecedente(idPaciente, idVacuna);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
